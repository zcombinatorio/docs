...
- [Create Proposal](/api-reference/quantum-markets/create-proposal) - Launch a new market with 2-8 options
- [Market Status](/api-reference/quantum-markets/market-status) - Get live prices, see which option is winning or has won, and check end time to trigger the next market
