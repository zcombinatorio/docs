...
Deposit (split) regular tokens into conditional tokens to participate in futarchy. When you deposit, your tokens are split equally into pass and fail conditional tokens.
