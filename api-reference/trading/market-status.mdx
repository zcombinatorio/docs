...
<ResponseField name="numOptions" type="number">
  Number of outcome options in the proposal
</ResponseField>
...
<ResponseField name="pools[].index" type="number">
  Pool index (corresponds to outcome option)
</ResponseField>
...
The winning outcome is determined by comparing the TWAP values across all outcome options at proposal finalization.
