...
Execute swaps in a proposal's AMM pools to trade conditional tokens. Each proposal has one pool per outcome option where you can trade conditional tokens.
